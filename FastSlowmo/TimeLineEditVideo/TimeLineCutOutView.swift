...
class TimeLineCutOutView: UIView {
    ...
    func setupControlLeftRight() {
        timeLineCutVideo = TimeLineCoreGraphic(frame: self.frame, backGroundColor: UIColor(displayP3Red: 1, green: 1, blue: 1, alpha: 0.5), colorStroke: .black)
        timeLineCutVideo.translatesAutoresizingMaskIntoConstraints = false
        self.addSubview(timeLineCutVideo)
        
        leftConstraint = timeLineCutVideo.leftAnchor.constraint(equalTo: self.leftAnchor)
        rightConstraint = self.rightAnchor.constraint(equalTo: timeLineCutVideo.rightAnchor)
        bottomConstraint = self.bottomAnchor.constraint(equalTo: timeLineCutVideo.bottomAnchor)
        topConstraint = timeLineCutVideo.topAnchor.constraint(equalTo: self.topAnchor)
        ...
        leftControllView.leftAnchor.constraint(equalTo: timeLineCutVideo.leftAnchor).isActive = true
        ...
        leftControllView.centerYAnchor.constraint(equalTo: timeLineCutVideo.centerYAnchor).isActive = true
        
        rightControllView.rightAnchor.constraint(equalTo: timeLineCutVideo.rightAnchor).isActive = true
        ...
        rightControllView.centerYAnchor.constraint(equalTo: timeLineCutVideo.centerYAnchor).isActive = true
